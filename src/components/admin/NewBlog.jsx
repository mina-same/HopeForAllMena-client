            ...
            <Form onSubmit={handleSubmit}>
              <Row>
                <Col md={8}>
                  <Form.Group className="mb-4">
                    <Form.Label className="modern-label fw-semibold mb-2">
                      <i className="fas fa-heading me-2 text-[#ECF2FF]"></i>Title *
                    </Form.Label>
                    <Form.Control
                      type="text"
                      name="title"
                ...
                <Col md={4}>
                  <Form.Group className="mb-4">
                    <Form.Label className="modern-label fw-semibold mb-2">
                      <i className="fas fa-folder me-2 text-[#ECF2FF]"></i>Category *
                    </Form.Label>
                    <Form.Select
                      name="category"
              ...
              <Form.Group className="mb-4">
                <Form.Label className="modern-label fw-semibold mb-2">
                  <i className="fas fa-align-left me-2 text-[#ECF2FF]"></i>Excerpt *
                </Form.Label>
                <Form.Control
                  as="textarea"
                  rows={3}
              ...
              <Form.Group className="mb-4">
                <Form.Label className="modern-label fw-semibold mb-3">
                  <i className="fas fa-edit me-2 text-[#ECF2FF]"></i>Content *
                </Form.Label>
              ...
              <Form.Group className="mb-4">
                <Form.Label className="modern-label fw-semibold mb-2">
                  <i className="fas fa-tags me-2 text-[#ECF2FF]"></i>Tags
                </Form.Label>
                <Form.Control
                  type="text"
                  name="tags"
              ...
              <Form.Group className="mb-4">
                <Form.Label className="modern-label fw-semibold mb-2">
                  <i className="fas fa-image me-2 text-[#ECF2FF]"></i>Featured Image *
                </Form.Label>
              ...
              <Row>
                <Col md={6}>
                  <Form.Group className="mb-4">
                    <Form.Label className="modern-label fw-semibold mb-2">
                      <i className="fas fa-globe me-2 text-[#ECF2FF]"></i>Publication Status
                    </Form.Label>
                    <Form.Select
                      name="status"
        ...
        <div className="sticky-top" style={{ top: '2rem' }}>
              ...
              <div className="guideline-section mb-4">
                <div className="d-flex align-items-center mb-3">
                  <div className="guideline-icon bg-[#ECF2FF] bg-opacity-10 rounded-circle p-2 me-3">
                    <i className="fas fa-pen-fancy text-[#ECF2FF]"></i>
                  </div>
          ...
          <Card className="modern-card border-0 shadow-sm">
            <Card.Body className="p-4 text-center">
              <div className="mb-3">
                <i className="fas fa-rocket fa-2x text-[#ECF2FF] mb-2"></i>
